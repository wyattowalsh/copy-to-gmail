...
const baseLight: ThemeTokens = {
  ...
  focus: '#265df0',
  editorBg: '#efe3d4',
  editorGrid: 'rgb(38 93 240 / 3%)',
  panelMuted: '#fff7ed',
  shadow: '0 28px 80px rgb(69 51 31 / 14%)',
  radius: '24px',
  density: 'comfortable',
}
...
export const THEME_PRESETS: ThemeDefinition[] = [
  preset('normal-light', 'Normal Light', 'light', baseLight),
  preset('normal-dark', 'Normal Dark', 'dark', baseDark),
