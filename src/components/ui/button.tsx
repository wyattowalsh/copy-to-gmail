...
const buttonVariants = cva(
  'inline-flex min-w-0 items-center justify-center gap-2 rounded-[var(--control-radius)] border text-sm font-semibold leading-none transition-colors duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--focus)] focus-visible:ring-offset-2 focus-visible:ring-offset-[color:var(--bg)] disabled:pointer-events-none disabled:opacity-55 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        primary:
        ...
        icon: 'border-[color:var(--line-strong)] bg-[color:var(--paper)] text-[color:var(--ink)] hover:border-[color:var(--primary)] hover:text-[color:var(--primary)]',
      },
      size: {
